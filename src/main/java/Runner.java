...
//
//        CurrentOrder currentOrder1 = new CurrentOrder(0.00, user1);
//        CurrentOrder currentOrder2 = new CurrentOrder(0.00, user2);
//        CurrentOrder currentOrder3 = new CurrentOrder(0.00, user3);
//        DBHelper.saveOrUpdate(currentOrder1);
//        DBHelper.saveOrUpdate(currentOrder2);
//        DBHelper.saveOrUpdate(currentOrder3);
//
//        PreviousOrder previousOrder1 = new PreviousOrder(0.00, user1, new GregorianCalendar(2018, 2, 22), new GregorianCalendar(2018, 2, 23), shop);
//        PreviousOrder previousOrder2 = new PreviousOrder(0.00, user1, new GregorianCalendar(2018, 2, 28), new GregorianCalendar(2018, 3, 01), shop);
//        PreviousOrder previousOrder3 = new PreviousOrder(0.00, user1, new GregorianCalendar(2018, 3, 06), new GregorianCalendar(2018, 3, 07), shop);
